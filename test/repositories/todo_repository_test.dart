...
import 'package:todo_flutter_mockito/repositories/todo_repository.dart';
...
main() {
  ...
  test('''
    ...
    when(dio.get(any)).thenAnswer(
        (_) async => Response(data: jsonDecode(jsonData), statusCode: 200));
    final result = await repository?.fetchTodos();
    expect(result[1].title, 'quis ut nam facilis et officia qui');
  });
}
